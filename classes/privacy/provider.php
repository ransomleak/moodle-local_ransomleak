...
/**
 * Privacy Subsystem implementation for local_ransomleak.
 *
 ...
 *
 * The plugin stores no personal data of its own — it only writes an external-tool
 * configuration (lti_types) to the site. Personal data exchanged during an LTI
